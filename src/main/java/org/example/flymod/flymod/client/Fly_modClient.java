    ...
    private void checkAntiFlyKick() {
        ...
        if (client.player != null && isFlying) {
            ...
            if (floatingTickCount > 20) {
                ...
                PacketHelper.sendPosition(client.player.getPos().subtract(0.0, 0.0433D, 0.5));
                floatingTickCount = 0;
            }
        }
    }
